...
# with command line options: HhhAnalysis/MCProduction/Herwigpp_diHiggsProduction_B2_cff -s GEN,SIM --mc --datatier GEN-SIM --beamspot Realistic25ns13TeV2016Collision --conditions 80X_mcRun2_asymptotic_2016_miniAODv2_v1 --eventcontent RAWSIM --era Run2_2016 --fileout file:out_sim.root -n 1 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('HhhAnalysis/MCProduction/Herwigpp_diHiggsProduction_B2_cff nevts:1'),
...
process.generator = cms.EDFilter("ThePEGGeneratorFilter",
    ...
    diHiggsProduction = cms.vstring('cd /Herwig/Particles/', 
        ...
        'setup H 35 H 341.4142 2.41 24.1 0 0 0 1 0', 
        ...
        'set MEHiggsPair:SelfCoupling 6.44136', 
        'set MEHiggsPair:hhHCoupling -0.6345'),
