...
# with command line options: DiHiggs_Run2_cfi --runUnscheduled -s PAT --conditions 80X_mcRun2_asymptotic_2016_miniAODv2_v1 --eventcontent MINIAODSIM --era Run2_2016 --filein file:out_reco.root --fileout file:out_miniaod.root -n 10 --no_exec
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:out_miniaod.root'),
