...
# with command line options: HhhAnalysis/MCProduction/Herwigpp_diHiggsProduction_B3_cff -s GEN,SIM --mc --datatier GEN-SIM --beamspot Realistic25ns13TeV2016Collision --conditions 80X_mcRun2_asymptotic_2016_miniAODv2_v1 --eventcontent RAWSIM --era Run2_2016 --fileout file:out_sim.root -n 1 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('HhhAnalysis/MCProduction/Herwigpp_diHiggsProduction_B3_cff nevts:1'),
