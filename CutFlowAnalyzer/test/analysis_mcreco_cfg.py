...
from HhhAnalysis.DataFormats.EventContent_version10_cff import *
...
file_list = "HhhAnalysis.CutFlowAnalyzer."+sys.argv[2]+"_cff"
...
process.load("HhhAnalysis.MuJetProducer.MuJetProducer_cfi")
