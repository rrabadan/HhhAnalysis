...
config.General.requestName = 'DYJetsToLL_M-10to50_TuneCUETP8M1_amcatnloFXFX_pythia8_02'
...
config.Data.outputDatasetTag = 'DYJetsToLL_M-10to50_TuneCUETP8M1_amcatnloFXFX_pythia8_02'
