...
for ev in TCha:
  ...
  MuMu_cut              = (ev.isMuMu and ev.lep1_pt>20 and fabs(ev.lep1_eta)<2.4 and ev.lep2_pt>10 and fabs(ev.lep2_eta)<2.4 and ev.ll_M>12)
  MuEl_cut              = (ev.isMuEl and ev.lep1_pt>20 and fabs(ev.lep1_eta)<2.4 and ev.lep2_pt>15 and fabs(ev.lep2_eta)<2.5 and ev.ll_M>12)
  ElMu_cut              = (ev.isElMu and ev.lep1_pt>25 and fabs(ev.lep1_eta)<2.5 and ev.lep2_pt>10 and fabs(ev.lep2_eta)<2.4 and ev.ll_M>12)
  ElEl_cut              = (ev.isElEl and ev.lep1_pt>25 and fabs(ev.lep1_eta)<2.5 and ev.lep2_pt>15 and fabs(ev.lep2_eta)<2.5 and ev.ll_M>12)
