...
draw1D(filelist, "muon1_eta", "(50,-2.5,2.5)", "#Eta", cut, benchmarks, "h_MU1_eta.pdf", Lumi, NORM)
draw1D(filelist, "muon2_eta", "(50,-2.5,2.5)", "#Eta", cut, benchmarks, "h_MU2_eta.pdf", Lumi, NORM)
...
draw1D(filelist, "b1jet_eta", "(50,-2.5,2.5)", "Pt [GeV]", cut, benchmarks, "h_J1_eta.pdf", Lumi, NORM)
draw1D(filelist, "b2jet_eta", "(50,-2.5,2.5)", "Pt [GeV]", cut, benchmarks, "h_J2_eta.pdf", Lumi, NORM)
