...
# Dataset to plot
#filelist = [TT_ch, DY_ch, VV_ch, sT_ch, Wjet_ch, ttV_ch, Data_ch] #If you draw a StackPlot place the smaller samples at the beginning and data as last one
#benchmarks = ["TTbar","DY","VV","singTop","Wjet","ttV","Data"]
filelist = [DY_ch, TT_ch, Data_ch] #If you draw a StackPlot place the smaller samples at the beginning and data as last one
benchmarks = ["DY","TTbar","Data"]
#Cuts and Ordering
...
#GEN
#RECO Di-Leptons
draw1D(filelist, "muon1_pt", "(50,10,100)", "Pt [GeV]", cut, benchmarks, "h_MU1_pt.pdf", Lumi, NORM, DataOrMC)
draw1D(filelist, "muon2_pt", "(50,10,100)", "Pt [GeV]", cut, benchmarks, "h_MU2_pt.pdf", Lumi, NORM, DataOrMC)
draw1D(filelist, "muon1_eta", "(50,-3,3)", "#Eta", cut, benchmarks, "h_MU1_eta.pdf", Lumi, NORM, DataOrMC)
draw1D(filelist, "muon2_eta", "(50,-3,3)", "#Eta", cut, benchmarks, "h_MU2_eta.pdf", Lumi, NORM, DataOrMC)
draw1D(filelist, "mass_l1l2", "(40,20,150)", "m(l,l)", cut, benchmarks, "h_M_l1l2.pdf", Lumi, NORM, DataOrMC)
draw1D(filelist, "dR_l1l2", "(50,0,5)", "#Delta R(l,l)", cut, benchmarks, "h_DR_l1l2.pdf", Lumi, NORM, DataOrMC)
#RECO Di-Jets
draw1D(filelist, "b1jet_pt", "(50,20,200)", "Pt [GeV]", cut, benchmarks, "h_J1_pt.pdf", Lumi, NORM, DataOrMC)
draw1D(filelist, "b2jet_pt", "(50,20,100)", "Pt [GeV]", cut, benchmarks, "h_J2_pt.pdf", Lumi, NORM, DataOrMC)
draw1D(filelist, "b1jet_eta", "(50,-3.,3.)", "#Eta", cut, benchmarks, "h_J1_eta.pdf", Lumi, NORM, DataOrMC)
draw1D(filelist, "b2jet_eta", "(50,-3.,3.)", "#Eta", cut, benchmarks, "h_J2_eta.pdf", Lumi, NORM, DataOrMC)
draw1D(filelist, "mass_b1b2", "(40,40,180)", "m(j,j)", cut, benchmarks, "h_M_b1b2.pdf", Lumi, NORM, DataOrMC)
draw1D(filelist, "dR_b1b2", "(50,0,5)", "#Delta R(j,j)", cut, benchmarks, "h_DR_b1b2.pdf", Lumi, NORM, DataOrMC)
#RECO MIX
#draw1D(filelist, "mass_trans", "(50,5,100)", "M_trans [GeV]", cut, benchmarks, "h_MT.pdf", Lumi, NORM)
draw1D(filelist, "dR_l1l2b1b2", "(50,0,5)", "#Delta R(lljj)", cut, benchmarks, "h_dR_l1l2b1b2.pdf", Lumi, NORM, DataOrMC)
draw1D(filelist, "dphi_llmet", "(50,-4,4)", "#Delta #Phi (ll,MET)", cut, benchmarks, "h_Dphi_llmet.pdf", Lumi, NORM, DataOrMC)
