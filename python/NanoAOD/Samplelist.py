...
MCNanoAODGlobalTag = "RunIISummer16NanoAOD"
...
datasets.append('/SingleMuon/Run2016B-05Feb2018_ver1-v1/NANOAOD')
NumSample.append('-28'); sampleN_short.append('SingleMuonRun2016Bver1')
MCxsections.append(-1.0)
datasets.append('/SingleMuon/Run2016B-05Feb2018_ver2-v1/NANOAOD')
NumSample.append('-29'); sampleN_short.append('SingleMuonRun2016Bver2')
MCxsections.append(-1.0)
datasets.append('/SingleMuon/Run2016C-05Feb2018-v1/NANOAOD')
NumSample.append('-30'); sampleN_short.append('SingleMuonRun2016C')
MCxsections.append(-1.0)
datasets.append('/SingleMuon/Run2016D-05Feb2018-v1/NANOAOD')
NumSample.append('-31'); sampleN_short.append('SingleMuonRun2016D')
MCxsections.append(-1.0)
datasets.append('/SingleMuon/Run2016E-05Feb2018-v1/NANOAOD')
NumSample.append('-32'); sampleN_short.append('SingleMuonRun2016E')
MCxsections.append(-1.0)
datasets.append('/SingleMuon/Run2016F-05Feb2018-v1/NANOAOD')
NumSample.append('-33'); sampleN_short.append('SingleMuonRun2016F')
MCxsections.append(-1.0)
datasets.append('/SingleMuon/Run2016G-05Feb2018-v1/NANOAOD')
NumSample.append('-34'); sampleN_short.append('SingleMuonRun2016G')
MCxsections.append(-1.0)
datasets.append('/SingleMuon/Run2016H-05Feb2018_ver2-v1/NANOAOD')
NumSample.append('-35'); sampleN_short.append('SingleMuonRun2016Hver2')
MCxsections.append(-1.0)
datasets.append('/SingleMuon/Run2016H-05Feb2018_ver3-v1/NANOAOD')
NumSample.append('-36'); sampleN_short.append('SingleMuonRun2016Hver3')
MCxsections.append(-1.0)
datasets.append('/SingleElectron/Run2016B-05Feb2018_ver1-v1/NANOAOD')
NumSample.append('-37'); sampleN_short.append('SingleElectronRun2016Bver1')
MCxsections.append(-1.0)
datasets.append('/SingleElectron/Run2016B-05Feb2018_ver2-v1/NANOAOD')
NumSample.append('-38'); sampleN_short.append('SingleElectronRun2016Bver2')
MCxsections.append(-1.0)
datasets.append('/SingleElectron/Run2016C-05Feb2018-v1/NANOAOD')
NumSample.append('-39'); sampleN_short.append('SingleElectronRun2016C')
MCxsections.append(-1.0)
datasets.append('/SingleElectron/Run2016D-05Feb2018-v1/NANOAOD')
NumSample.append('-40'); sampleN_short.append('SingleElectronRun2016D')
MCxsections.append(-1.0)
datasets.append('/SingleElectron/Run2016E-05Feb2018-v1/NANOAOD')
NumSample.append('-41'); sampleN_short.append('SingleElectronRun2016E')
MCxsections.append(-1.0)
datasets.append('/SingleElectron/Run2016F-05Feb2018-v1/NANOAOD')
NumSample.append('-42'); sampleN_short.append('SingleElectronRun2016F')
MCxsections.append(-1.0)
datasets.append('/SingleElectron/Run2016G-05Feb2018-v1/NANOAOD')
NumSample.append('-43'); sampleN_short.append('SingleElectronRun2016G')
MCxsections.append(-1.0)
datasets.append('/SingleElectron/Run2016H-05Feb2018_ver2-v1/NANOAOD')
NumSample.append('-44'); sampleN_short.append('SingleElectronRun2016Hver2')
MCxsections.append(-1.0)
datasets.append('/SingleElectron/Run2016H-05Feb2018_ver3-v1/NANOAOD')
NumSample.append('-45'); sampleN_short.append('SingleElectronRun2016Hver3')
MCxsections.append(-1.0)
...
##/GluGluToRadionToHHTo2B2VTo2L2Nu_M-1000_narrow_13TeV-madgraph-v2/RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/MINIAODSIM

##/GluGluToRadionToHHTo2B2VTo2L2Nu_M-1000_narrow_13TeV-madgraph-v2/RunIISummer16NanoAOD-PUMoriond17_05Feb2018_94X_mcRun2_asymptotic_v2-v1/NANOAODSIM
