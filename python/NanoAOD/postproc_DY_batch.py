...
if "DoubleMuon" in jobtype:
    ...
    #modules = [puWeight(), btagSF2016_cMVA(),  muonScaleRes2016(), mht_hh(), HHbbWWProducer(True, DYestimation = True, verbose = 1) ]
    modules = [ puWeight(), countHistogramAll_2016(), jetmetUncertainties2016(), btagSF2016_cMVA(),  muonScaleRes2016(), mht_hh(), HHbbWWProducer(True, DYestimation = True, verbose = 1) ]
