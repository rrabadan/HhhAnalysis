...
def runCMSHIG17006Limits(masslist, workdir, generatescripts, runscripts):
	...
	for mass in masslist:
		...
		script.write("combine  --rMax 500 -m {mass} -n GGToX0ToHHTo2B2L2Nu_M{mass}_{ch} GGToX0ToHHTo2B2L2Nu_M{mass}_{ch}_combine_workspace.root &> GGToX0ToHHTo2B2L2Nu_M{mass}_{ch}_{suffix}.log\n".format(mass = mass, ch = channel,  suffix =scriptsuffix))
...
def getlimits_nncut(masslist, nnout, outdir_prefix):
	...
	outdir = outdir_prefix+"_"+nnout+"_"+nncutsuffix+"_limits/"
        workdir = "/afs/cern.ch/work/t/tahuang/CombinedLimit/ForGithub/CMSSW_8_1_0/src/HiggsAnalysis/CombinedLimit/HH_WWbb/"+outdir
...
#getlimits_nncut(masslist, "nnout_MTonly", "GGToX0ToHHTo2B2L2Nu")
getlimits_nncut(masslist, "nnout_MTandMT2", "GGToX0ToHHTo2B2L2Nu")
getlimits_nncut(masslist, "nnout_MTandMT2_MJJ", "GGToX0ToHHTo2B2L2Nu")
